...
A<-matrix(c(100,93.95),nrow=1,ncol=2,dimnames=list(NULL,c("LeftToRight","RightToLeft")), byrow=TRUE)
bp<-barplot(A,col=c("blue"),main="Success With Bayesian Sequencing",ylab="Success (%)")
